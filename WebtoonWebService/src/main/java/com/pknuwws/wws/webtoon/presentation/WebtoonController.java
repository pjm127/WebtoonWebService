...
public class WebtoonController {
    ...
    private ResponseEntity< Page<WebtoonResponse>> getAllWebtoon(
    ...
    private ResponseEntity<WebtoonResponse> getWebtoon(@PathVariable("webtoonId") Long webtoonId){
    ...
    private ResponseEntity< Page<WebtoonResponse>> getGenreWebtoon(
    ...
    private ResponseEntity< Page<WebtoonResponse>> getNewWebtoon(
        @PageableDefault @Parameter(name="page") int page)
    {
    ...
    private ResponseEntity<Page<WebtoonResponse>> searchWebtoon(
